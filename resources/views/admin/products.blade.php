    ...
    <div class="row">
        ...
        <div class="col-md-12 col-sm-12 mt-0">
            <div class="x_panel sg-shadow">
                <div class="x_title">
                    <h2>{{ $title }}</h2>
                    <button id="addProductBtn" class="btn btn-sm btn-danger pull-right">Add New Product</button>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content" id="productsTableDiv">
                    <table id="productsDataTable" width="100%" style="font-size: 100%; width:100%;" class="table table-bordered table-striped">
                        ...
                        <tbody id="productsTbody">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#" class="view_product btn btn-info btn-sm" data-product_id="{{$product->id}}"><i class="fa fa-file-archive-o"></i> View</a>
                                    <a href="#" class="edit_product btn btn-success btn-sm" data-product_id="{{$product->id}}"><i class="fa fa-edit"></i> Edit</a>
                                    <a href="#" class="delete_product btn btn-danger btn-sm" data-product_id="{{$product->id}}"><i class="fa fa-remove"></i> Delete</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
                ...
                $('#productsDataTable').DataTable({
                    ...
                    columns:[
                        ...
                        },
                        {
                            ...
                            render: function(id){
                                return `
                                <a href="#" class="view_product btn btn-info btn-sm" data-product_id="${id}"><i class="fa fa-file-archive-o"></i> View</a>
                                <a href="#" class="edit_product btn btn-success btn-sm" data-product_id="${id}"><i class="fa fa-edit"></i> Edit</a>
                                <a href="#" class="delete_product btn btn-danger btn-sm" data-product_id="${id}"><i class="fa fa-remove"></i> Delete</a>
                                `;
                            }
                        }
                    ],
